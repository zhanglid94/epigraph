    ...
    <NavbarWrapper className="navbar">
      <Container>
        ...
        <MenuArea className={state.searchToggle ? 'active' : ''}>
          <ScrollSpyMenu className="menu" menuItems={navMenu} />
          {/* end of main menu */}
          ...
          <AnchorLink href="#home" offset={84}>
            <Button className="trail" title="Connect Wallet (coming soon)" disabled />
          </AnchorLink>
      ...
      <MobileMenu className={`mobile-menu ${state.mobileMenu ? 'active' : ''}`}>
        <Container>
          ...
          <Button title="Connect Wallet (comming soon)" />
        </Container>
      </MobileMenu>
      {/* end of mobile menu */}
    </NavbarWrapper>
